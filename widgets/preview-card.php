    ...
    protected function render() {
        ...
        <div class="image-card">
            <div class="image-wrapper">
                <!--  two brackets will look inside arrays $settings[ 'image' ][ 'url' ] ); will look inside the image array and find the url
                    [image] => Array
                                (
                                    [url] => http://localhost/elementor_dev/wp-content/plugins/elementor/assets/images/placeholder.png
                                    [id] => 
                                ) -->
